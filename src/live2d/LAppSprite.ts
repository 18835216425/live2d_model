...
export class LAppSprite {
   ...
   */
  public render(programId: WebGLProgram, canvas: HTMLCanvasElement, gl: WebGLRenderingContext): void {
    if (this._texture == null) {
      // ロードが完了していない
      return;
    }
    // const gl = LAppLive2DManager._gl[this._index]
    // 初回描画時
    if (this._firstDraw) {
      // 何番目のattribute変数か取得
      ...
      // const canvas = LAppLive2DManager._canvas[this._index]
      // 頂点バッファ、座標初期化
      {
